...
Usage:
    uv run modal run --detach experiments/snowflake/eval_only.py \
      --checkpoint /checkpoints/snowflake/seed0_1000s_bs512_aug1_<ts>.pt \
      --temp-eliminate 0.0
"""
...
def run(
    ...
    step_cfg = StepConfig(
        ...
        augment=augment,
        augment_dihedral=False,    # snowflake: digit-perm only
        vocab_dim=VOCAB,
    )
